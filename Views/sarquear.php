                  ...
                  <tr>
					...
					<?php if($_SESSION['StockPower']['tipo_usuario'] !=3) {?>
                      <td>
						  ...
						  <?php } else if ($provider['id_operador'] == $_SESSION['StockPower']['id'] && $provider['status'] == 4 
						  && $_SESSION['StockPower']['tipo_usuario'] = 3){?>	  
					          <a href="<?= BASE_URL.'sarquear/conduzir/'.$provider['id']?>" class="btn btn-danger">Conduzir</a>
						  <?php } else if ($provider['id_usuario'] == $_SESSION['StockPower']['id'] && $provider['status'] == 2){ ?>	  
					...
					<?php }else{ ?>
					     <td>
						 <?php }if ($provider['id_operador'] == $_SESSION['StockPower']['id'] && $provider['status'] == 4){?>	
                          <div class="btn-group">
